# ------------------------------------------------------------------
# VISIONFLUX COLAB SERVER - FULL VIDEO GENERATION WITH RIFE
...
def generate(req: GenerateRequest):
    ...
    try:
        ...
        if len(frames) > 1:
            ...
            print(f"✅ Video generated successfully! {len(frames)} frames")
...
# ------------------------------------------------------------------
# Start server with proper async handling for Colab
# ------------------------------------------------------------------
nest_asyncio.apply()
